...
#ifndef CPL_CLASS_BOSS
#define CPL_CLASS_BOSS

#include <Shoot.h>
#include <Reactor.h>
#include <Laser.h>

#define CPL_NO_BOSS			-1

#define CPL_BOSS_Y_2D			SIGLBD_PG_BOTTOM + 4.0f
#define CPL_BOSS_Y_3D			SIGLBD_PG_BOTTOM + 4.0f
...
typedef enum {
	...
	CPL_MAX_BOSS_EVENTS	// Only for management purpouses
} CPL_BOSS_EVENTS;
...
public:
	...
	void ActivateLaser(CPL_BOSS_LASER Laser);
...
extern vector<CBoss*>	Players;		///<Amount of Players available for the game
