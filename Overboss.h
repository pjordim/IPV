...
#ifndef CPL_CLASS_OVERBOSS
#define CPL_CLASS_OVERBOSS

#include <Shoot.h>
#include <Reactor.h>
#include <Laser.h>

#define CPL_NO_OVERBOSS			-1

#define CPL_OVERBOSS_Y_2D			SIGLBD_PG_BOTTOM + 4.0f
#define CPL_OVERBOSS_Y_3D			SIGLBD_PG_BOTTOM + 4.0f
...
typedef enum {
	...
	CPL_MAX_OVERBOSS_EVENTS	// Only for management purpouses
} CPL_OVERBOSS_EVENTS;
...
class COverboss : public CExplosiveChar
{
	//Attributes
public:
	...
	void ActivateLaser(CPL_OVERBOSS_LASER Laser);
...
extern vector<COverboss*>	Players;		///<Amount of Players available for the game
